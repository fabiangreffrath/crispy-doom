...
A complete history of changes and releases can be found in the [Wiki](./docs/changelog-history.md) or on the [Releases](https://github.com/fabiangreffrath/crispy-doom/releases) page.
 ...
 * Brief instructions to set up a build system on Windows can be found [in the Crispy Doom Wiki](./docs/build-windows.md). A much more detailed guide is provided [in the Chocolate Doom Wiki](https://www.chocolate-doom.org/wiki/index.php/Building_Chocolate_Doom_on_Windows), but applies to Crispy Doom as well for most parts.
 * There are also instructions for building on [Linux](./docs/build-linux.md) and [MacOS](./docs/build-macos.md)
 ...
 * **[New Controls](./docs/controls.md) (With default bindings)**
 * **[Crispness](./docs/crispness.md)**
